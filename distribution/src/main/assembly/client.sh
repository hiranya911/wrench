...
java -Duser.dir=$WRENCH_HOME -Dwrench.cluster.name=Grades -Dwrench.config.dir=$WRENCH_HOME/conf -Dwrench.zk.dir=$WRENCH_HOME/db/zk -classpath $WRENCH_CLASSPATH edu.ucsb.cs.wrench.client.WrenchClient $*
