...
public class WrenchManagementService {
  ...
  public interface Iface {
    ...
    public void notifyAppend(String transactionId) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void notifyAppend(String transactionId, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.notifyAppend_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void notifyAppend(String transactionId) throws org.apache.thrift.TException
    {
      send_notifyAppend(transactionId);
      recv_notifyAppend();
    }

    public void send_notifyAppend(String transactionId) throws org.apache.thrift.TException
    {
      notifyAppend_args args = new notifyAppend_args();
      args.setTransactionId(transactionId);
      sendBase("notifyAppend", args);
    }

    public void recv_notifyAppend() throws org.apache.thrift.TException
    {
      notifyAppend_result result = new notifyAppend_result();
      receiveBase(result, "notifyAppend");
      return;
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void notifyAppend(String transactionId, org.apache.thrift.async.AsyncMethodCallback<notifyAppend_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      notifyAppend_call method_call = new notifyAppend_call(transactionId, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class notifyAppend_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String transactionId;
      public notifyAppend_call(String transactionId, org.apache.thrift.async.AsyncMethodCallback<notifyAppend_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.transactionId = transactionId;
      }

      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("notifyAppend", org.apache.thrift.protocol.TMessageType.CALL, 0));
        notifyAppend_args args = new notifyAppend_args();
        args.setTransactionId(transactionId);
        args.write(prot);
        prot.writeMessageEnd();
      ...
      public void getResult() throws org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        (new Client(prot)).recv_notifyAppend();
      }
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("notifyAppend", new notifyAppend());
      return processMap;
    }
    ...
    public static class notifyAppend<I extends Iface> extends org.apache.thrift.ProcessFunction<I, notifyAppend_args> {
      public notifyAppend() {
        super("notifyAppend");
      }

      public notifyAppend_args getEmptyArgsInstance() {
        return new notifyAppend_args();
      }
      ...
      public notifyAppend_result getResult(I iface, notifyAppend_args args) throws org.apache.thrift.TException {
        notifyAppend_result result = new notifyAppend_result();
        iface.notifyAppend(args.transactionId);
        return result;
      }
    }
...
;
  ...
  public static class notifyAppend_args implements org.apache.thrift.TBase<notifyAppend_args, notifyAppend_args._Fields>, java.io.Serializable, Cloneable   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("notifyAppend_args");

    private static final org.apache.thrift.protocol.TField TRANSACTION_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("transactionId", org.apache.thrift.protocol.TType.STRING, (short)1);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new notifyAppend_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new notifyAppend_argsTupleSchemeFactory());
    }
    ...
    static {
      ...
      tmpMap.put(_Fields.TRANSACTION_ID, new org.apache.thrift.meta_data.FieldMetaData("transactionId", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(notifyAppend_args.class, metaDataMap);
    }

    public notifyAppend_args() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public notifyAppend_args(notifyAppend_args other) {
      if (other.isSetTransactionId()) {
        this.transactionId = other.transactionId;
      }
    }

    public notifyAppend_args deepCopy() {
      return new notifyAppend_args(this);
    }
    ...
    public notifyAppend_args setTransactionId(String transactionId) {
      this.transactionId = transactionId;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof notifyAppend_args)
        return this.equals((notifyAppend_args)that);
      return false;
    }

    public boolean equals(notifyAppend_args that) {
      if (that == null)
        return false;
    ...
    public int compareTo(notifyAppend_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      notifyAppend_args typedOther = (notifyAppend_args)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("notifyAppend_args(");
      boolean first = true;
    ...
    private static class notifyAppend_argsStandardSchemeFactory implements SchemeFactory {
      public notifyAppend_argsStandardScheme getScheme() {
        return new notifyAppend_argsStandardScheme();
      }
    }

    private static class notifyAppend_argsStandardScheme extends StandardScheme<notifyAppend_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, notifyAppend_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, notifyAppend_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class notifyAppend_argsTupleSchemeFactory implements SchemeFactory {
      public notifyAppend_argsTupleScheme getScheme() {
        return new notifyAppend_argsTupleScheme();
      }
    }

    private static class notifyAppend_argsTupleScheme extends TupleScheme<notifyAppend_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, notifyAppend_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetTransactionId()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, notifyAppend_args struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.transactionId = iprot.readString();
  ...
  public static class notifyAppend_result implements org.apache.thrift.TBase<notifyAppend_result, notifyAppend_result._Fields>, java.io.Serializable, Cloneable   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("notifyAppend_result");


    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new notifyAppend_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new notifyAppend_resultTupleSchemeFactory());
    }
...
;
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(notifyAppend_result.class, metaDataMap);
    }

    public notifyAppend_result() {
    }

    /**
     * Performs a deep copy on <i>other</i>.
     */
    public notifyAppend_result(notifyAppend_result other) {
    }

    public notifyAppend_result deepCopy() {
      return new notifyAppend_result(this);
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof notifyAppend_result)
        return this.equals((notifyAppend_result)that);
      return false;
    }

    public boolean equals(notifyAppend_result that) {
      if (that == null)
        return false;
    ...
    public int compareTo(notifyAppend_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      notifyAppend_result typedOther = (notifyAppend_result)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("notifyAppend_result(");
      boolean first = true;
    ...
    private static class notifyAppend_resultStandardSchemeFactory implements SchemeFactory {
      public notifyAppend_resultStandardScheme getScheme() {
        return new notifyAppend_resultStandardScheme();
      }
    }

    private static class notifyAppend_resultStandardScheme extends StandardScheme<notifyAppend_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, notifyAppend_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, notifyAppend_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class notifyAppend_resultTupleSchemeFactory implements SchemeFactory {
      public notifyAppend_resultTupleScheme getScheme() {
        return new notifyAppend_resultTupleScheme();
      }
    }

    private static class notifyAppend_resultTupleScheme extends TupleScheme<notifyAppend_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, notifyAppend_result struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
      }

      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, notifyAppend_result struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
      }
    }
